...
%% plots
the = 0 : 1 / length(psd_est2_avg2) : 1 - 1 / length(psd_est2_avg2);
the2 = 0 : 1 / length(psd_est2_smooth2) : 1 - 1 / length(psd_est2_smooth2);
...
% subplot(132)
plot(K,acf_est2_winmult2),axis([-N N -1 4]), xlabel('$k$','Interpreter','latex', 'fontsize', 20), 
...
figure(14)
stem(K(N-20 : N+20),acf_est2_winmult2(N-20 : N+20)), axis([-20 20 -1 4]), xlabel('$k$','Interpreter','latex', 'fontsize', 20), 
